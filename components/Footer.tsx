...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-[#0f0f0f] via-[#1a1a1a] to-[#0a0a0a] relative z-10 overflow-hidden">
      {/* Elegant decorative line */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#C4705B]/30 to-transparent" />
          ...
          >
            <div className="flex items-center justify-center lg:justify-start">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-[#C4705B]/20 to-[#8A4A32]/20 rounded-full blur-xl" />
                <img 
                  src="/logo-img.png" 
            ...
            <ul className="space-y-5">
              {[
                ...
                <li key={index} className="flex items-start gap-4 text-sm">
                  <div className="w-10 h-10 bg-white/5 backdrop-blur-sm rounded-lg flex items-center justify-center border border-white/10 flex-shrink-0">
            ...
            <div className="pt-6 border-t border-white/10">
              ...
              <form onSubmit={handleNewsletterSubmit} className="space-y-3">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  type="submit"
                  className="w-full px-4 py-3 bg-gradient-to-r from-[#C4705B] to-[#8A4A32] text-white rounded-lg hover:shadow-lg hover:shadow-[#C4705B]/20 transition-all duration-300 flex items-center justify-center gap-2 text-sm font-medium tracking-wide"
                >
                  Subscribe
